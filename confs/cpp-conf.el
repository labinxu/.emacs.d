...
(defun semantic-c++-mode-hook()
  (message "* calling semantic-c++-mode-hook")
  (semantic-mode t)
  (semantic-stickyfunc-mode t)
  (semantic-idle-summary-mode t)
  (global-semantic-highlight-func-mode t))

(defun semantic-init-function()
  (setq semantic-idle-scheduler-timer 0.2)
  (dolist (dir include-paths)
    (semantic-add-system-include dir 'c++-mode))
  (dolist (dir '("/usr/include/" "/usr/include/c++/4.2.1"))
    (semantic-add-system-include dir 'c++-mode)))
